...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=JetBrains+Mono\&weight=700\&size=18\&pause=900\&color=00D9FF\&center=true\&vCenter=true\&width=900\&height=45\&lines=Patent+Co-Inventor+%7C+ALCF+IoT+Lightweight+Crypto+%F0%9F%94%90;Team+Lead+PARTH+%40+TATA+Centre+AI%26ML%2C+NIT+Trichy+%F0%9F%94%AC;Building+AI+Security+%7C+GenAI+%7C+Full-Stack+Systems+%E2%9A%A1;Young+Tech+Visionary+Award+%7C+Hackathon+Winner+%F0%9F%8F%86;Hack+for+Good.+Build+for+Bharat.+%F0%9F%87%AE%F0%9F%87%B3)](https://git.io/typing-svg)
...
identity:
  name       : "Nayan"
  username   : "NAYANBECS24"
  role       : "AI · Cybersecurity · Full-Stack Builder"
...
mission:
  ...
  mantra     : "Hack for Good. Build for Bharat."

core_stack:
  ai_ml      : ["TensorFlow", "PyTorch", "Keras", "OpenCV", "RAG", "LangChain"]
  security   : ["TOR Analysis", "Cyber Forensics", "IoT Security", "ASCON", "ZK Proofs"]
  full_stack : ["HTML", "CSS", "JavaScript", "PHP", "MySQL", "React", "Flask"]
  advanced   : ["GenAI", "TinyML", "Federated Learning", "Blockchain", "Quantum ML"]
...
I build systems that have clear architecture, real-world problem-solving, security thinking, and working prototype potential.
...
* Cybercrime intelligence prototypes
* Edge AI and IoT security systems
...
* Convert hackathon ideas into portfolio-grade products
* Keep learning, shipping, and improving
...
| 🎖️ | Achievement                                   | Issued / Event                               | Year |
| :-: | --------------------------------------------- | -------------------------------------------- | :--: |
|  📜 | **Published Patent Co-Inventor**              | Indian Patent Office — ALCF IoT Security     | 2025 |
|  🥇 | **1st Place — AI For ALL Ideathon**           | TATA Centre for AI & ML, NIT Tiruchirappalli | 2026 |
|  🥈 | **2nd Place & Top 10 Finalist**               | Tamil Nadu Police Cyber Crime Hackathon      | 2025 |
|  🥇 | **Young Tech Visionary Award**                | Innoventia 2K26                              | 2026 |
|  🌏 | **Top 112 Teams — Asia Level**                | Cardano Hackathon Asia 2025                  | 2025 |
|  🥇 | **1st Prize — IdeaForge Ideathon**            | AVIT, Team PARTH                             | 2026 |
|  🏆 | **Champion — Mini Product Showcase**          | AVIT Chennai, Result Analyzer                | 2026 |
|  🥇 | **1st Prize — Science Day Model Competition** | AgriSmart 2.0                                | 2026 |
|  🚀 | **Semi-Finalist**                             | ET-AI Hackathon 2026                         | 2026 |
...
```txt
╔══════════════════════════════════════════════════════════════════════════════════╗
║       ALCF — ADAPTIVE AI-LIGHTWEIGHT CRYPTO FRAMEWORK                          ║
║              for Real-Time IoT Security                                        ║
╠══════════════════════════════════════════════════════════════════════════════════╣
║  Patent No.     : Indian Patent Application No. 202541117496 A                 ║
║  Status         : Published in Patent Office Journal 51/2025                   ║
║  Role           : Co-Inventor                                                  ║
╠══════════════════════════════════════════════════════════════════════════════════╣
║  Architecture   : Device Layer  →  Edge Layer  →  Cloud Layer                  ║
║  Crypto Stack   : ASCON Lightweight Cryptography + On-Device TinyML            ║
║  Detection      : < 2 seconds                                                  ║
║  Accuracy       : 95%                                                          ║
║  Encryption     : < 200 μs on ESP32                                            ║
...
To make education more local, accessible, and understandable for rural Bharat by converting educational content into regional, contextual, narration-ready lessons.

### 🧩 System Flow

```txt
NCERT / Learning Content
        ↓
Content Understanding Layer
        ↓
Gurukul Context Engine
        ↓
Local Analogy Generator
        ↓
Regional Language Translation Layer
        ↓
Narration-Ready Script
        ↓
AI Visual + Voice Generation
        ↓
WhatsApp / SMS / Low-Bandwidth Delivery
```

### 🔥 Key Features

* Hyper-local examples based on learner geography
* Regional language and dialect support
* NCERT content simplification
* AI-generated lesson scripts
* Culturally relevant visuals
* Low-bandwidth delivery for 2G/3G regions
* Designed for rural learners and inclusive education

### 🛠️ Tech Direction

![Llama-3](https://img.shields.io/badge/Llama--3-412991?style=flat-square\&logo=meta\&logoColor=white)
![Bhashini](https://img.shields.io/badge/Bhashini_API-138808?style=flat-square)
![Stable Diffusion](https://img.shields.io/badge/Stable_Diffusion+LoRA-FF6B35?style=flat-square)
...
<details>
<summary><b>🔐 TOR Sentinel — Privacy-Preserving Federated AI for TOR Traffic Analysis</b></summary>

<br/>

> Award-winning cybersecurity AI system

### 🎯 Mission

To support cybercrime intelligence without exposing raw PII or sensitive traffic data.

### ⚙️ Core Architecture

```txt
ISP Node 1        ISP Node 2        ISP Node 3
    ↓                 ↓                 ↓
...
Federated Learning Server
              ↓
TOR Traffic Pattern Intelligence
              ↓
Probabilistic Investigation Support
              ↓
Blockchain-Based Judicial Audit Trail
```

### 🔥 Highlights

* Federated learning across distributed nodes
* Zero raw PII sharing
* Adaptive Time-Window Correlation for TOR latency
* Blockchain audit trail for tamper-proof evidence chain
* Simulated investigation time reduction from weeks to hours

![Federated Learning](https://img.shields.io/badge/Federated_Learning-FF4500?style=flat-square)
...
<details>
<summary><b>⚔️ AEGIS — Adaptive Enterprise Guardrail & Intelligence System</b></summary>

<br/>

> GenAI cybersecurity platform concept for enterprise software protection

### 🧠 Dual Engine Design

| Engine         | Role          | Purpose                                                                   |
| -------------- | ------------- | ------------------------------------------------------------------------- |
| **GhostGuard** | Shift Left    | Blocks package threats, dependency risks, and slopsquatting-style attacks |
| **Chimera**    | Protect Right | Creates adaptive deception intelligence and attacker profiling workflows  |

### ⚙️ System Map

```txt
Developer / Runtime Ecosystem
          ↓
Package + Dependency Intelligence
          ↓
Knowledge Graph Layer
          ↓
Vector Search + Threat Memory
          ↓
GhostGuard Semantic Firewall
          ↓
...
![Llama-3](https://img.shields.io/badge/Llama--3--8B-412991?style=flat-square\&logo=meta\&logoColor=white)
...
<details>
<summary><b>⚛️ Q-Shield — Hybrid Quantum-Classical Ransomware Precognition</b></summary>

<br/>

> Ransomware detection before encryption damage begins

### 🎯 Goal

Move ransomware defense from **reactive detection** to **precognitive behavioral prediction**.
...
System Call Stream
        ↓
Kernel-Level Behavior Monitor
        ↓
System Call Rhythm Analysis
        ↓
Graph-Based Behavior Encoding
        ↓
Quantum Feature Layer
        ↓
Classical Neural Classifier
        ↓
...
![TF Quantum](https://img.shields.io/badge/TensorFlow_Quantum-FF6F00?style=flat-square\&logo=tensorflow\&logoColor=white)
![PennyLane](https://img.shields.io/badge/PennyLane-4CAF50?style=flat-square)
...
<details>
<summary><b>🌏 SOVARTH / Sovereign Nexus — Privacy-First Cardano DeFi for Asia</b></summary>

<br/>

> Top 112 Teams Asia — Cardano Hackathon Asia 2025

### 🎯 Mission

Build a sovereign financial identity and asset layer for underserved and unbanked users.

### 🧱 Key Concepts

* Unified wallet for identity, assets, credit, and intents
* Data-Bound Assets using CIP-68 NFTs
* Decentralized identity using Atala PRISM
* ZK credit scoring using Halo2 zk-SNARKs
* IoT oracle-based collateral verification
* Cross-chain flow with Hydra, Milkomeda, and Wormhole
...
Atala PRISM DID
    ↓
Asset + Credit Profile
    ↓
Data-Bound Asset Layer
    ↓
ZK Credit Scoring
    ↓
Cross-Chain Transaction Layer
    ↓
Sovereign DeFi Access
```

![Cardano](https://img.shields.io/badge/Cardano-0033AD?style=flat-square\&logo=cardano\&logoColor=white)
![Halo2](https://img.shields.io/badge/Halo2_zk--SNARKs-7B2FBE?style=flat-square)
...
<details>
<summary><b>🎙️ EchoShield — AI Voice Deepfake & Vishing Defense</b></summary>

<br/>

> Real-time voice security system

### 🎯 Problem

AI voice cloning can be used for fraud, impersonation, and vishing attacks.

### 🛡️ Solution

EchoShield analyzes audio liveness and synthetic voice traces to detect suspicious calls.
...
<details>
<summary><b>🔏 ID Masker — AI-Powered PII Detection & Redaction</b></summary>

<br/>

> Privacy tool for detecting and masking sensitive information
...
<img height="175em" src="https://github-readme-stats.vercel.app/api?username=NAYANBECS24&show_icons=true&theme=tokyonight&include_all_commits=true&count_private=true&hide_border=true&bg_color=0D1117&title_color=00D9FF&icon_color=7B2FBE&text_color=FFFFFF&rank_icon=github"/>

<img height="175em" src="https://github-readme-stats.vercel.app/api/top-langs/?username=NAYANBECS24&layout=compact&langs_count=8&theme=tokyonight&hide_border=true&bg_color=0D1117&title_color=00D9FF&text_color=FFFFFF"/>

<br/>

<img src="https://streak-stats.demolab.com/?user=NAYANBECS24&theme=tokyonight&hide_border=true&background=0D1117&ring=00D9FF&fire=7B2FBE&currStreakLabel=00D9FF&sideNums=FFFFFF&dates=888888" />
...
[![Activity Graph](https://github-readme-activity-graph.vercel.app/graph?username=NAYANBECS24\&bg_color=0D1117\&color=00D9FF\&line=7B2FBE\&point=00D9FF\&area=true\&area_color=00D9FF30\&hide_border=true\&custom_title=Nayan%27s%20Contribution%20Graph)](https://github.com/ashutosh00710/github-readme-activity-graph)
...
<picture>
  ...
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/NAYANBECS24/NAYANBECS24/output/github-contribution-grid-snake.svg">
...
class Nayan2026:
    def __init__(self):
        self.username = "NAYANBECS24"
        self.role = "AI · Cybersecurity · Full-Stack Builder"
        self.base = "Chennai, Tamil Nadu, India"
        self.mission = "Build secure, intelligent, and socially useful systems"
    ...
    def philosophy(self):
        ...
        It is the foundation of every system worth building.
...
│  02. Convert the idea into a clear system flow               │
│  03. Design the architecture before scaling                  │
│  04. Build a working prototype fast                          │
│  05. Add AI only where it creates real value                 │
│  06. Keep security and privacy at the foundation             │
│  07. Make the demo simple enough for anyone to understand    │
│  08. Improve based on feedback and real use                  │
└──────────────────────────────────────────────────────────────┘
```
...
> Open to **research collaborations, internships, high-impact hackathons, AI/ML projects, cybersecurity projects, and GenAI product building**.
